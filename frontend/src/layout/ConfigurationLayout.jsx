...
import Header from '../components/Layout/Header'; // Header mungkin sama
import ConfigurationSidebar from '../components/Layout/ConfigurationSidebar'; // Sidebar khusus konfigurasi
